...
public class BuyDTO {
	...
	private	int			book_id;		// 구매한 책의 아이디
	private	String		book_title;		// 구매한 책의 제목
	...
	private	String		deliveryName;	// 배송받는 사람이름
	private	String		deliveryTel;	// 배송지 전화번호
	private	String		deliveryAddress;// 배송지 주소
	private	String		sanction;		// 배송상태
