...
//-------------------------------------------------------------------------------------------------
// 년도에 따른 월별 판매수량 데이터를 실어나르는 Bean
//-------------------------------------------------------------------------------------------------
public class BuyMonthDTO {
	...
	public String toString() {
		return "BuyMonthDTO [month01=" + month01 + ", month02=" + month02 + ", month03=" + month03 + ", month04="
				+ month04 + ", month05=" + month05 + ", month06=" + month06 + ", month07=" + month07 + ", month08="
				+ month08 + ", month09=" + month09 + ", month10=" + month10 + ", month11=" + month11 + ", month12="
				+ month12 + ", total=" + total + "]";
	}
	

	
} // End - public class BuyMonthDTO
